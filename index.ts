...
async function prebratLeaderboard() {
    while (!ukolyDokonceny) {
        ...
        async function describePicture(driver: any) {
            ...
            aktualniCviceni = "cekat"
            console.log("kliknuto: describePicture")
        }
        ...
        async function vypracovatCviceni() {
